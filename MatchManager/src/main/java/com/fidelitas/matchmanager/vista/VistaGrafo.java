...
public class VistaGrafo {
    ...
    public VistaGrafo(ListaEventos listaEventos) {
    ...
    public VBox render() {
        ...
        cbEventos.setOnAction(e -> {
            ...
            Map<String, Set<String>> ady = ev.getGrafoEquipos().getAdyacencias();

            for (String equipo : ady.keySet()) {
                String linea = equipo + " → " + String.join(", ", ady.get(equipo));
